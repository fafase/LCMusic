...
public class AudioManager : MonoBehaviour
{
    ...
    private IList<AudioSource> audioList = new List<AudioSource>();
    private IDictionary<string, AudioClip> clipDict = new Dictionary<string, AudioClip>();
    ...
    public void PlayAudio(string clipName, float volume = 1.0f, float pitch = 1.0f, bool loop = false, bool forcePlay = false)
    {
        ...
        if (clipDict.ContainsKey(clipName) == false)  {  return; }
